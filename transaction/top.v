...
always @(posedge clk, negedge iRst) begin: TOP_RS232_MODULE0_SEQ_LOGIC
    if ((iRst == 0)) begin
...
always @(RS232_Module0_write_addr, RS232_Module0_tx_addr) begin: TOP_RS232_MODULE0_COMB_LOGIC
...
always @(posedge iClk, negedge iRst) begin: TOP_RS232PROGRAMMER0_IO_WRITE_SYNC
    if ((iRst == 0)) begin
